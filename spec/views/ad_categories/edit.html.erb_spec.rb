...
RSpec.describe "ad_categories/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit ad_category form" do
    render

    assert_select "form[action=?][method=?]", ad_category_path(@ad_category), "post" do
